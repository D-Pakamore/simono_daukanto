...
TEMPLATE_DIRS = [
    Path(BASE_DIR, 'templates'),  # Add this line
]

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-9yz4msnj0-&9+1@4=c1tezjwe2kiaxka4yq4a3&+xg)-#=rj1p'

STATIC_URL = '/static/'
STATICFILES_DIRS = (
    Path(BASE_DIR, "static"),
)
STATIC_ROOT = Path(BASE_DIR, 'staticfiles')  # Adjust the path as needed.
